...
import { Eye, Trash2, PlusCircle, GraduationCap, DollarSign, Briefcase, Hash } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
function ManageTrainingServicesPage() {
  ...
  try {
    ...
    const response = await api.get('/services?categoryId=2'); 
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Memuat data jasa pelatihan...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Manajemen Jasa Instalasi</h1>
                <p className="text-gray-500 mt-1">Kelola semua jasa Pemgasangan yang ditawarkan</p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          {services.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Belum ada jasa pemasangan</h3>
              <p className="text-gray-500">Tambahkan jasa pemasangan pertama Anda untuk memulai</p>
              <Link href="/dashboard/services/create">
                          ...
                          <Dialog open={isDialogOpen && selectedService?.id === service.id} onOpenChange={setIsDialogOpen}>
                            ...
                            <DialogContent className="sm:max-w-[500px]">
                              <DialogHeader>
                                ...
                                <DialogDescription>
                                  Lihat dan edit informasi jasa pemasangan
                                </DialogDescription>
                              </DialogHeader>
                              {selectedService && (
                                <div className="py-4 space-y-4">
                                  ...
                                  <div>
                                    ...
                                    <Textarea 
                                      ...
                                      placeholder="Tambahkan deskripsi jasa pelatihan..."
                                    />
                                  </div>
                                  <div>
